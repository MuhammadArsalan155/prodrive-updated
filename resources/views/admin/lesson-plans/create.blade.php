    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fas fa-book text-primary mr-2"></i>Create Lesson Plan
            </h1>
            ...
            <div class="col-xl-10 col-lg-12">
                <div class="card shadow-lg border-0 rounded-lg">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.lesson-plans.store') }}" method="POST" id="lessonPlanForm">
                            @csrf
                            <div class="row">
                                {{-- Lesson Plan Title --}}
                                <div class="col-12 mb-3">
                                    <label for="title" class="form-label">
                                        <i class="fas fa-heading text-primary mr-2"></i>Lesson Plan Title <span
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" placeholder="Enter Lesson Plan Title" name="title"
                                    ...
                                    <div class="card border-left-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="alert alert-info">
                                                ...
                                                Add feedback questions that students and instructors will answer after
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-1">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="number"
                                                                                ...
                                                                                value="{{ $question['display_order'] ?? $index + 1 }}"
                                                                                min="1" required>
                                                                    ...
                                                                    <div class="col-1 d-flex align-items-center">
                                                                        <button type="button"
                                                                            class="btn btn-danger btn-sm remove-question mt-4">
                                ...
                                <div class="col-12 mt-4">
                                    <button type="submit" class="btn btn-primary btn-block">
                                        <i class="fas fa-save mr-2"></i>Create Lesson Plan
                                    </button>
                                </div>
                            </div>
                        </form>
