                    ...
                    <form action="{{ route('admin.managers.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password">
                                        <i class="fas fa-lock mr-1 text-primary"></i>Password <span class="text-danger">*</span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password_confirmation">
                                        <i class="fas fa-lock mr-1 text-primary"></i>Confirm Password <span class="text-danger">*</span>
                                    </label>
                            ...
                            {{-- <div class="col-md-6">
                                <div class="form-group">
                                    <label for="license_number">
                                        <i class="fas fa-id-badge mr-1 text-primary"></i>License Number
                                    </label>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save mr-1"></i> Create Manager
                            </button>
