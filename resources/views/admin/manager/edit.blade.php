...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-user-edit mr-2 text-primary"></i>Edit Manager
        </h1>
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex align-items-center">
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Edit Manager: {{ $manager->name }}</h6>
                </div>
                <div class="card-body">
                    @if(session('error'))
                    ...
                    <form action="{{ route('admin.managers.update', $manager->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="name">
                                        <i class="fas fa-user mr-1 text-primary"></i>Name <span class="text-danger">*</span>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="email">
                                        <i class="fas fa-envelope mr-1 text-primary"></i>Email <span class="text-danger">*</span>
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password">
                                        <i class="fas fa-lock mr-1 text-primary"></i>Password <small class="text-muted">(Leave blank to keep current password)</small>
                                    </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mt-4">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" {{ old('is_active', $manager->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save mr-1"></i> Update Manager
                            </button>
